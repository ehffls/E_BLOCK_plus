...
<body>
   ...
   <div class="ui container" style="margin-top: 20px;">
      <div class="ui pointing menu">
         <a class="item active" href="/E_BLOCK_plus/equip/add/askList.jsp">비품추가신청조회</a> <a class="item" href="/E_BLOCK_plus/equip/purc/askList.jsp">비품구매신청조회</a> <a class="item" href="/E_BLOC_plus/equip/inb/askList.jsp">비품입출신청조회</a>
      </div>
   ...
   $(function(){
      ...
      function approval(outcome){
         ...
         $.ajax({
            ...
            ,url:'/E_BLOCK_plus/equip/add/sign.ebp'
                  //결재사원번호는 로직에서 쿠키로 얻음

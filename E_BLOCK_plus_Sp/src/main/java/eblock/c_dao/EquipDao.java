...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	public int add_ask(Map<String, Object> pMap) {
		result = sqlSessionTemplate.insert(nameSpace+"add_ask", pMap);
		return result;
	}
	//─────[ 대기중인 비품내역추가신청 수정하기 | 테스트완료(10/05) ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public int add_askUpd(Map<String, Object> pMap) {
		result = sqlSessionTemplate.update(nameSpace+"add_askUpd",pMap);
		return result;
	}
	...
	public List<Map<String, Object>> add_askList(Map<String, Object> pMap) {
		...
		list = sqlSessionTemplate.selectList(nameSpace+"add_askList", pMap);
		return list;
	}
	//다중조건 검토문 예제 구현하기!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
	//[결재권자]
	...
	public int add_sign(List<Map<String, Object>> pList) {
		result = sqlSessionTemplate.update(nameSpace+"add_sign",pList);
		return result;
	}
///////////////////// 상위 코드 단위테스트 완료 [ 10/04 ] //////////////////////////////////////////
	//─────[ (신청가능)비품테이블에서 비품 조회하기 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public List<Map<String, Object>> add_equipList(Map<String, Object> pMap) {
		list = sqlSessionTemplate.selectList(nameSpace+"add_equipList", pMap);
		return list;
	}
	//[결재권자]
	//─────[ (신청가능)비품테이블에 비품가격 수정하기 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public int add_equipCost(Map<String, Object> pMap) {
		result = sqlSessionTemplate.update(nameSpace+"add_equipCost",pMap);
		return result;
	}
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	public int mk_add(Map<String, Object> pMap) {
		result = sqlSessionTemplate.update(nameSpace+"mk_add",pMap);
		return result;
	}
	//[결재권자]
	//─────[ 등록된 거래처 수정하기 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public int mk_upd(Map<String, Object> pMap) {
		result = sqlSessionTemplate.update(nameSpace+"mk_upd",pMap);
		return result;
	}
	//─────[ 등록된 거래처 조회하기 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public List<Map<String, Object>> mk_list(Map<String, Object> pMap) {
		list = sqlSessionTemplate.selectList(nameSpace+"mk_list", pMap);
		return list;
	}
	//─────[ 등록된 거래처 조회하기 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
		public List<Map<String, Object>> mk_allList(Map<String, Object> pMap) {
		list = sqlSessionTemplate.selectList(nameSpace+"mk_allList", pMap);
		return list;
	}
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	public List<Map<String, Object>> purc_ask(Map<String, Object> pMap) {
		list = sqlSessionTemplate.selectList(nameSpace+"purc_ask", pMap);
		return list;
	}
	//─────[ 구매가능내역에서 비품구매 신청 수정하기 (취소포함) ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public int purc_askUpd(Map<String, Object> pMap) {
		result = sqlSessionTemplate.update(nameSpace+"purc_askUpd",pMap);
		return result;
	}
	//─────[ 비품구매신청내역 조회하기 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public List<Map<String,Object>> purc_askList(Map<String, Object> pMap) {
		list = sqlSessionTemplate.selectList(nameSpace+"purc_askList",pMap);
		return list;
	}
	//[결재권자]
	//─────[ 비품구매신청내역 결재하기 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public int purc_sign(List<Map<String, Object>> pList) {
		result = sqlSessionTemplate.update(nameSpace+"purc_sign",pList);
		return result;
	}
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	public List<Map<String, Object>> inb_eqList(Map<String, Object> pMap) {
		list = sqlSessionTemplate.selectList(nameSpace+"inb_eqList", pMap);
		return list;
	}
	//─────[ 비품입출신청내역에 비품입출 신청하기 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public int inb_ask(Map<String, Object> pMap) {
		result = sqlSessionTemplate.insert(nameSpace+"inb_ask",pMap);
		return result;
	}
	//─────[ 비품입출신청내역에서 신청 수정하기(취소포함) ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public int inb_askUpd(Map<String, Object> pMap) {
		result = sqlSessionTemplate.update(nameSpace+"inb_askUpd",pMap);
		return result;
	}
	//[결재권자]
	//─────[ 비품입출신청내역 조회 ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public List<Map<String,Object>> inb_askList(Map<String, Object> pMap) {
		list = sqlSessionTemplate.selectList(nameSpace+"inb_iolist",pMap);
		return list;
	}
	//[결재권자]
	//─────[ 비품상태 조회) ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	...
	public int inb_sign(Map<String, Object> pMap) {
		result = sqlSessionTemplate.update(nameSpace+"inb_sign",pMap);
		return result;
	}
	//[결재권자]
	//─────[ 입고비품상태관리 프로시저로 처리하기 (수리반출|반입완료|폐기) ]────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	public int inb_change(Map<String, Object> pMap) {
		result = sqlSessionTemplate.update(nameSpace+"inb_change",pMap);
		return result;
	}
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	public List<Map<String, Object>> ask_list(Map<String, Object> pMap) {
		list = sqlSessionTemplate.selectList(nameSpace+"ask_list", pMap);
		return list;
	}

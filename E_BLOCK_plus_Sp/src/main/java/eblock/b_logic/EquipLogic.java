...
public class EquipLogic {
	...
	@Autowired
	private EquipDao equipDao = null;
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	//[결재권자]
	//비품분류 등록하기
	public int sort_add(Map<String, Object> pMap, String e_no) {
		pMap.put("e_no",e_no);
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	public int add_ask(Map<String, Object> pMap, String e_no) {
		pMap.put("ask_eno", e_no);
	...
	public int add_sign(Map<String, Object> pMap, String e_no) {
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	//구매가능내역에서 비품구매 신청하기
	public List<Map<String, Object>> purc_ask(Map<String, Object> pMap, String e_no) {
		pMap.put("ask_eno", e_no);
	...
	//[결재권자]
	//비품구매신청내역 결재하기
	public int purc_sign(Map<String, Object> pMap, String e_no) {
		logger.info("pMap.get(\"param\") : "+pMap.get("param"));
		//넘어온 파람을 분할한다.
		String[] words = pMap.get("param").toString().split(",");
		//넘어온걸 반복문을 위해 리스트로 작성한다.
		...
		for(int i=1;i<words.length;i++) {
			...
			newMap.put("sign_eno", e_no);//결재자번호.. 쿠키에서 얻어야함.
			newList.add(newMap);
		}
		logger.info("newList : "+newList);
		//작성한 리스트를 넘김

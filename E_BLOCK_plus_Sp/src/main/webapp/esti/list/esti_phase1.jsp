...
<script type="text/javascript">
	//데이터테이블 자료뿌리기
	var ph1_table = $('#phase1_table').DataTable({
		//조회개수 조정
		aLengthMenu : [ 5, 10, 15 ],
	       //페이지 네이션 버튼 한글로 변경
		language : {
		...
		ajax:{
			//내가 요청한 견적시신청건 중 1단계결재가 완료된 건(1단계)
			url : "/E_BLOCK_plus/esti/list/list/phase1",//"./esti_phase2_JSON.jsp",
		...
		columns : [ {
	           ...
	           "data" : "SIGN_ENO1"//결재차장 사원번호
	        }, {
	           "data" : "OUTCOME1"//차장급 결재상태
	        }, {
	           "data" : "SIGN_DATE1"//결재일자
	        }, {
	...
	//테이블 헤더 가운데 정렬
	$('#phase1_table th').attr("class", "center aligned");
</script>
<!-- DataTables스크립트 끝-->
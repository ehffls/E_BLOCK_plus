...
<body>
	...
	<div class="ui container" style="margin-top: 20px;">
		<div class="ui pointing menu">
			<a class="item active" href="/E_BLOCK_plus/equip/add/askList.jsp">비품추가신청조회</a> <a class="item" href="/E_BLOCK_plus/equip/purc/askList.jsp">비품구매신청조회</a> <a class="item" href="/E_BLOCK_plus/equip/inb/askList.jsp">비품입출신청조회</a>
		</div>
			...
			<div align="center">
				<div class="ui orange buttons" id="btn_approval">
					...
					<div class="ui floating dropdown icon button">
						...
						<div class="menu">
							<div class="item" id="btn_permit">
								<i class="thumbs up icon"></i> 승인
							</div>
							<div class="item" id="btn_dismiss">
								<i class="thumbs down icon"></i> 기각
							</div>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function approval(outcome) {
			...
			$.ajax({
				...
				url : '/E_BLOCK_plus/equip/add/sign.ebp', //결재사원번호는 로직에서 쿠키로 얻음

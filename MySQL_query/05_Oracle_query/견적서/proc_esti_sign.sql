CREATE OR REPLACE PROCEDURE EBLOCK_OSUB.proc_esti_sign(esti_pano IN number,  sign_peno IN number
                                                      ,poutcome IN varchar2, sign_prsn IN varchar2
                                                      ,msg OUT varchar2)
IS
...
BEGIN
    SELECT esti_ano, esti_email, ask_eno, ask_date, note, esti_price
         ...
         ,ec_no, esti_ok
      INTO sign_state.esti_ano, sign_state.esti_email, sign_state.ask_eno, sign_state.ask_date
         , sign_state.note, sign_state.esti_price
        ...
        IF(sign_state.outcome1 = 'est-3' AND sign_state.outcome2 = 'est-3') THEN
            ...
            IF(sign_state.outcome1 = 'est-3' AND sign_state.outcome2 = 'est-3' AND sign_state.outcome3 = 'est-3') THEN
                IF(sign_state.esti_ok = 0) THEN
                    ...
                    values(SEQ_ESTI_ANO.nextval, sign_state.esti_ano, sign_state.esti_email
                                               , sign_state.ask_eno,  sign_state.ask_date
                                               , sign_state.note,     sign_state.esti_price
                          ...
                          , sign_state.sign_eno3, TO_CHAR(sysdate,'YYYY-MM-DD'), sign_prsn, sign_state.ec_no);
